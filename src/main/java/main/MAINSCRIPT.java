...
public class MAINSCRIPT extends JPanel implements ActionListener {
  ...
  public void drawScore(Graphics2D g) {
    ...
    g.drawString(sco, SCREEN_SIZE / 2 + 96, SCREEN_SIZE + 16);
